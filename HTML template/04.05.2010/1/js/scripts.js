...
function PageLoad() {
	...
	setTimeout(function() {
		...
		$('body').append('<audio loop autostop volume="0" id="audio"><source src="https://b922bde52f23a8481830-83cb7d8d544f653b52d1a1621f05ea9d.ssl.cf3.rackcdn.com/audio/MASTERqwav.mp3" type="audio/mpeg" /></audio>');
				...
				$('body').waitForImages({
					finished: function() {
						...
						setTimeout(function() {
							...
							TweenMax.set($(".swiper-pagination-bullet-active .subtitle"), {
								opacity: 0,
								transform: 'translate3d(0,15vh,0)',
								delay: 0
							});
							TweenMax.set($(".swiper-pagination-bullet-active .title"), {
								opacity: 0,
								transform: 'translate3d(0,15vh,0)',
								delay: 0
							});
							TweenMax.set($(".footer-button-wrap"), {
								opacity: 0,
								transform: 'translate3d(0,15vh,0)',
								delay: 0,
								ease: Power2.easeOut
							});
							TweenMax.set($(".showcase-counter, .swiper-pagination-bullet-active .counter, .arrows-wrap"), {
								opacity: 0,
								delay: 0,
							});
							TweenMax.to($("#showcase-holder"), 0.8, {
								force3D: true,
								opacity: 1,
								scale: 1,
								delay: 0.8,
							...
							TweenMax.to($(".swiper-pagination-bullet-active .subtitle"), 0.4, {
								force3D: true,
								opacity: 1,
								y: 0,
								delay: 0.9,
							...
							TweenMax.to($(".swiper-pagination-bullet-active .title"), 0.4, {
								force3D: true,
								opacity: 1,
								y: 0,
								delay: 0.95,
							...
							TweenMax.to($(".footer-button-wrap"), 0.4, {
								force3D: true,
								opacity: 1,
								y: 0,
								delay: 1,
							...
							TweenMax.to($(".showcase-counter, .swiper-pagination-bullet-active .counter, .arrows-wrap"), 0.3, {
								force3D: true,
								opacity: 1,
								delay: 0.95,
								ease: Power2.easeOut
...
function FirstLoad() {
	...
	$('a.ajax-link').on('click', function() {
		...
		TweenMax.to($("#showcase-carousel .swiper-slide-active"), 0.4, {
			force3D: true,
			x: -250,
			opacity: 0,
			delay: 0.05,
		...
		TweenMax.to($("#showcase-carousel .swiper-slide-active").next(), 0.4, {
			force3D: true,
			x: -250,
			opacity: 0,
			delay: 0.1,
		...
		TweenMax.to($("#showcase-carousel .swiper-slide-active").next().next(), 0.4, {
			force3D: true,
			x: -250,
			opacity: 0,
			delay: 0.15,
		...
		TweenMax.to($("#showcase-carousel"), 0.5, {
			force3D: true,
			opacity: 0,
			delay: 0.1,
			ease: Power1.easeInOut
		});
		TweenMax.to($("#large-showcase-carousel .swiper-slide-active").prev(), 0.4, {
			force3D: true,
			x: -250,
			opacity: 0,
			delay: 0.05,
		...
		TweenMax.to($("#large-showcase-carousel .swiper-slide-active"), 0.4, {
			force3D: true,
			x: -250,
			opacity: 0,
			delay: 0.1,
		...
		TweenMax.to($("#large-showcase-carousel .swiper-slide-active").next(), 0.4, {
			force3D: true,
			x: -250,
			opacity: 0,
			delay: 0.15,
		...
		TweenMax.to($("#large-showcase-carousel"), 0.5, {
			force3D: true,
			opacity: 0,
			delay: 0.1,
			ease: Power1.easeInOut
	...
	$('.next-ajax-link-page').on('click', function() {
		...
		TweenMax.to($(".next-page-title"), 0.6, {
			force3D: true,
			yPercent: -10,
			delay: 0,
			ease: Power2.easeInOut
		...
		TweenMax.to($(".page-title"), 0.6, {
			force3D: true,
			y: -navtitleheight,
			delay: 0.1,
			ease: Power2.easeInOut
		});
		TweenMax.set($(".page-subtitle"), {
			opacity: 0,
			scale: 1,
			y: navsubtitlemove,
			delay: 0.4
		});
		TweenMax.set($(".subtitle-info"), {
			opacity: 0,
			delay: 0.4
		});
		TweenMax.set($(".subtitle-name"), {
			opacity: 1,
			delay: 0.4
		});
		TweenMax.to($(".page-subtitle"), 0.3, {
	...
	$('.next-ajax-link-project').on('click', function() {
		...
		var navtitleheight = $(".hero-title").height()
		var navsubtitleheight = $(".hero-subtitle").height()
		TweenMax.to($(".next-project-title"), 0.6, {
			force3D: true,
			yPercent: -10,
			delay: 0,
			ease: Power2.easeInOut
		});
		TweenMax.to($(".main-subtitle"), 0.3, {
			force3D: true,
			opacity: 0,
			scale: 0.5,
			delay: 0,
	...
	if ($('#large-showcase-carousel').length > 0) {
		...
		var swiperOptions = {
			...
			on: {
				...
				init: function() {
					setTimeout(function() {
						TweenMax.to($('.swiper-slide-active').nextAll().find('.slide-title span'), 0, {
							scale: 1.1,
							x: 100,
							opacity: 0,
							ease: Power2.easeInOut
						});
						TweenMax.to($('.swiper-slide-active').nextAll().find('.slide-cat'), 0, {
							x: 20,
							opacity: 0,
							delay: 0.3,
							ease: Power2.easeIn
				...
				slideNextTransitionStart: function() {
					...
					prevslidetitle.staggerTo($('.swiper-slide-active').prevAll().find('.slide-title span'), 0.5, {
						scale: 0.9,
						x: -100,
						opacity: 0,
						ease: Power2.easeInOut
					...
					prevslidecaption.staggerTo($('.swiper-slide-active').prevAll().find('.slide-cat'), 0.5, {
						x: -20,
						opacity: 0,
						delay: 0.3,
						ease: Power2.easeIn
					...
					activeslidetitle.staggerTo($('.swiper-slide-active').find('.slide-title span'), 0.5, {
						scale: 1,
						x: 0,
						opacity: 1,
						scale: 1,
					...
					activeslidecaption.staggerTo($('.swiper-slide-active').find('.slide-cat'), 0.5, {
						x: 0,
						opacity: 1,
						scale: 1,
						delay: 0.6,
					...
					nextslidetitle.staggerTo($('.swiper-slide-active').nextAll().find('.slide-title span'), 0.5, {
						scale: 1.1,
						x: 100,
						opacity: 0,
						ease: Power2.easeInOut
					...
					nextslidecaption.staggerTo($('.swiper-slide-active').nextAll().find('.slide-cat'), 0.5, {
						x: 20,
						opacity: 0,
						delay: 0.3,
						ease: Power2.easeIn
				...
				slidePrevTransitionStart: function() {
					...
					var nextslidetitle = new TimelineLite();
					nextslidetitle.staggerTo($('.swiper-slide-active').next().find('.slide-title span'), 0.5, {
						scale: 0.9,
						x: 100,
						opacity: 0,
						ease: Power2.easeInOut
					...
					var nextslidecaption = new TimelineLite();
					nextslidecaption.staggerTo($('.swiper-slide-active').next().find('.slide-cat'), 0.5, {
						x: 40,
						opacity: 0,
						delay: 0,
						ease: Power2.easeIn
...
function Showcase() {
	if ($('#showcase-slider').length > 0) {
		...
		var swiperOptions = {
			...
			on: {
				...
				slideNextTransitionStart: function() {
					//TweenMax.set($(".swiper-slide"), {transform:"skew(10deg, 0deg)"});						
					var prevslidetitle = new TimelineLite();
					prevslidetitle.staggerTo($('.swiper-pagination-bullet-active').prev().find('.title span'), 0.5, {
						scale: 0.9,
						x: -100,
						opacity: 0,
						ease: Power2.easeInOut
					...
					var prevslidecaption = new TimelineLite();
					prevslidecaption.staggerTo($('.swiper-pagination-bullet-active').prev().find('.subtitle'), 0.5, {
						x: -20,
						opacity: 0,
						delay: 0.3,
						ease: Power2.easeIn
					...
					var activeslidetitle = new TimelineLite();
					activeslidetitle.staggerTo($('.swiper-pagination-bullet-active').find('.title span'), 0.5, {
						scale: 1,
						x: 0,
						opacity: 1,
						scale: 1,
					...
					var nextslidetitle = new TimelineLite();
					nextslidetitle.staggerTo($('.swiper-pagination-bullet-active').next().find('.title span'), 0.5, {
						scale: 1.1,
						x: 100,
						opacity: 0,
						ease: Power2.easeInOut
					...
					var nextslidecaption = new TimelineLite();
					nextslidecaption.staggerTo($('.swiper-pagination-bullet-active').next().find('.subtitle'), 0.5, {
						x: 20,
						opacity: 0,
						delay: 0.3,
						ease: Power2.easeIn
		...
		$('.footer-button').on('mousedown touchstart', function(event) {
			event.preventDefault();
			$('.button-border span[data-hover]').each(function() {
				$(this).attr('data-hover', "удерживайте");
			});
			...
			$(progress).animate({
				...
				TweenMax.to($(".swiper-pagination-bullet-active .subtitle"), 0.3, {
					force3D: true,
					opacity: 1,
					scale: 1,
					y: navsubtitleheight,
				...
				TweenMax.to($(".footer-button-wrap, .caption-border, .showcase-counter, .counter, .arrows-wrap"), 0.3, {
					force3D: true,
					opacity: 0,
					delay: 0,
					ease: Power2.easeOut
				});
				TweenMax.to($(".button-wrap.left"), 0.3, {
					force3D: true,
					opacity: 0,
					delay: 0.1,
					x: -20,
		...
		$('.footer-button').on('mouseup touchend', function(event) {
			...
			$(progress).stop();
			$('.button-border span[data-hover]').each(function() {
				$(this).attr('data-hover', "Click and Hold");
			});;
			$(progress).animate({
				width: '0%',
			}, 250);
