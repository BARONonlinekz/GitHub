jQuery(document).ready(function($) {
    ...
    var scrollPos = $('#cbtn2').offset().top - 100;
    ...
    var scrollPos13 = $('.hmob-block .img-res').offset().top+200;
    $(window).scroll(function () {
        var scrolled13 = $(window).scrollTop();
        if (scrolled13> scrollPos13){
            anim_mob_line(1);
        }
    });
    ...
    function ggg(active) {
        ...
        setTimeout(function () {
            ...
            $('#cl' + active + ' h2').addClass('active');
        },760);
        setTimeout(function() {
            $('#cl' + active + ' .cloud-a').removeClass('active');
            $('#cl' + active + ' h2').removeClass('active');
            setTimeout(function () {
