jQuery(document).ready(function($) {
    ...
    var lim;
    var checkText=true;
    var text_anim='Ответьте на несколько вопросов по созданию качественного Брендбука для Вашей компании!';
    ...
    function animateOn2() {
        $('.ctitle').addClass('bounceInDown').removeClass('opac')
        $('.cform').addClass('bounceInUp').removeClass('opac')
        setTimeout(function() {
            $('.line1').addClass('active')
        }, 0);
        setTimeout(function() {
            $('.img1').attr('src', 'assets/img/icons/1-1.png')
        }, 1000);
        setTimeout(function() {
            $('.line2').addClass('active')
        }, 2000);
        setTimeout(function() {
            $('.img2').attr('src', 'assets/img/icons/2-2.png')
        }, 3000);
        setTimeout(function() {
            $('.line3').addClass('active')
        }, 4000);
        setTimeout(function() {
            $('.img3').attr('src', 'assets/img/icons/3-3.png')
        }, 5000);
        setTimeout(function() {
            $('.line4').addClass('active')
        }, 6000);
        setTimeout(function() {
            $('.img4').attr('src', 'assets/img/icons/4-4.png')
        }, 13000);
        setTimeout(function() {
            $('.line5').addClass('active')
        }, 8000);
        setTimeout(function() {
            $('.img5').attr('src', 'assets/img/icons/5-5.png')
        }, 11000);
        setTimeout(function() {
            $('.line6').addClass('active')
        }, 10000);
        setTimeout(function() {
            $('.img6').attr('src', 'assets/img/icons/6-6.png')
        }, 9000);
        setTimeout(function() {
            $('.line7').addClass('active')
        }, 12000);
        setTimeout(function() {
            $('.img7').attr('src', 'assets/img/icons/7-7.png')
        }, 7000);
        var luch = 1;
        setInterval(function() {
            if (luch < 6) {
    ...
    function animateOn3() {
        $('.animated-img3,.animated-img2,.animated-img4,.animated-img5,.animated-img,.button-bg,.download').addClass('active');
        setInterval(function() {
            if (luch3 < 3) {
                $('#comluch-' + luch3 + ' img').animate({
                    opacity: 1
    ...
    $("body").on("click", ".carousel.mob .m-item", function() {
        var id = $(this).data("id")
        $('body').addClass('body-fix');
        $('.content-modal').empty();
        $('.content-modal').append('<img src="assets/img/portfolio/' + id + '.png">');
        if ($(window).width() > 1049) {
            $('.content-modal img').addClass('help_img');
        }
        $('.modal[data-id=modal-portfolio-mob]').fadeIn();
