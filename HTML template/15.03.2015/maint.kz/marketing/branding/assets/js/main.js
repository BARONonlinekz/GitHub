jQuery(document).ready(function($) {
    ...
    var onetrue = false;
    function animateOn1() {
        $('.ctitle[data-id=1]').addClass('bounceInDown').removeClass('opac')
        $('.cform[data-id=1]').addClass('bounceInUp').removeClass('opac')
        if(!onetrue){
            var onceN = false;
            function ttt() {
                animateOnN(1);
            ...
            function animateOnN(activeTxt) {
                ...
                $('.centered[data-id=' + activeTxt + ']').addClass('active animated jackInTheBox');
                setTimeout(function() {
                    $('.b-img[data-id=' + activeTxt + ']').removeClass('active');
                    $('.centered[data-id=' + activeTxt + ']').removeClass('active animated jackInTheBox');
                    if (!onceN && activeTxt == 1) {
                        return;
                    }
                    animateOnN(activeTxt + 1);
    ...
    var onetrue22 = false;
    function animateOn2() {
        $('.ctitle[data-id=2]').addClass('zoomInDown').removeClass('opac')
        $('.cform[data-id=2]').addClass('zoomInUp').removeClass('opac')
        if(!onetrue22){
            var onceBB = false;
            function ccc() {
                animateOnVV(1);
            ...
            function animateOnVV(activeTxt) {
                onetrue22 = true;
                if (activeTxt == 1) {
                    activeTxt = 2;
                }
                if (activeTxt == 4) {
                    activeTxt = 1;
                    animateOnVV(activeTxt + 1);
                }
                if (onceBB && activeTxt == 1) {
                    return;
                }
                $('.branding-item[data-id=' + activeTxt + ']').addClass('active');
                $('.branding-item[data-id=' + activeTxt + ']').find('.brandin-header img').addClass('animated bounce');
                setTimeout(function() {
                    $('.branding-item[data-id=' + activeTxt + ']').removeClass('active');
                    $('.branding-item[data-id=' + activeTxt + ']').find('.brandin-header img').removeClass('animated bounce');
                    if (!onceBB && activeTxt == 1) {
                        return;
                    }
                    animateOnVV(activeTxt + 1);
        ...
        $("#comluch-6").css("-webkit-animation", "leaves 2s ease-in-out infinite alternate", "animation", "leaves 2s ease-in-out infinite alternate")
        setInterval(function() {
            if (luch4 < 4) {
    ...
    var once = false;
    function animateOn3() {
        $('.animated-img3,.animated-img2,.animated-img,.animated-img4,.animated-img5,.button-bg,.download').addClass('active');
        setInterval(function() {
            if (luch3 < 3) {
                $('#comluch-' + luch3 + ' img').animate({
                    opacity: 1
    ...
    $("body").on("click",".carousel.pc .m-item",function(e){
        ...
        var image = $('<img>',{
            src : `assets/img/portfolio/${image_id}.jpg`
            // ,
