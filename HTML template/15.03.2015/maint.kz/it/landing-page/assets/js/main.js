jQuery(document).ready(function($) {
    ...
    var lim;
	var text_anim='Ответьте на несколько вопросов, чтобы заказать лэндинг, разработанный именно для ВАС!';
	var checkText=true;
        ...
        if (MQ == 'desktop' && bool) {
            ...
            $('body').on('click', nextArrow2, function() {
                setTimeout(function() {
                    ...
                    $('.r-text1, .r-text2, .r-text3, .r-text4').animate({
                        opacity: 1
                    }, 1000);
                    setTimeout(function() {
    ...
    if (!firstAnimate && hash == '#structure') {
        ...
        firstAnimate = !0
    } else if (!firstAnimate && hash == '#multilanding' || hash == '#function') {
        nextSection();
        setTimeout(function() {
            nextSection()
        }, 1000);
