jQuery(document).ready(function($) {
    ...
    var lim;
    var checkText = !0;
    var text_anim = 'Ответьте на несколько вопросов по разработке уникального сайта именно для ВАС!';
    ...
    function animateOn1() {
        ...
        if (!$('.kinds').hasClass('a-check')) {
            $('.kind-txt[data-id=' + 1 + ']').css({
                'background': '#60ff00',
                'border': '1px solid #60ff00',
                'border-left': '0'
            });
            $('.kind-txt2[data-id=' + 1 + '], .go_to[data-id=' + 1 + ']').css('color', '#000');
            $('.kind-number[data-id=' + 1 + ']').css('color', '#60ff00');
            $('.kind-title[data-id=' + 1 + ']').css({
                'color': '#000',
        ...
        function anim() {
            ...
            $('.kind-txt-img').hide();
            if (p_animate == 2 || p_animate == 3) {
                $('.kind-txt[data-id=' + p_animate + ']').css({
                    'border': '1px solid #60ff00',
                    'border-left': '0'
                });
                $('.kind-txt-img[data-id=' + p_animate + ']').show();
                $('.kind-txt2[data-id=' + p_animate + '], .go_to[data-id=' + p_animate + ']').css('color', '#000');
                $('.kind-number[data-id=' + p_animate + ']').css('color', '#60ff00');
                $('.kind-title[data-id=' + p_animate + ']').css({
                    'color': '#000',
                    'text-shadow': '0px 0px 0px rgba(103, 109, 83, 1), 0px 0px 0px rgba(103, 109, 83, 1)'
                });
                $('.kinds-imgs').hide().promise().done(function() {
                    $('.kinds-imgs[data-id=' + p_animate + ']').show();
                    p_animate++
                })
            } else {
                $('.kind-txt-img').hide();
    ...
    function animateOn2() {
        ...
        function ggg() {
            if (!$('.how').hasClass('a-check')) {
                $('.how').addClass('a-check');
                animateOn(1);
                once2 = !0
            }
        }
        ...
        function animateOn(onActive) {
            ...
            if (onActive == 6) {
                onActive = 1;
                animateOn(onActive + 1)
            }
            if (once2 && onActive == 1) {
                return
            }
            $('.micon[data-id=' + onActive + '] img').addClass('animated bounce');
            setTimeout(function() {
                $('.micon[data-id=' + onActive + '] img').removeClass('animated bounce');
                if (!once2 && onActive == 1) {
                    return
                }
                animateOn(onActive + 1)
    ...
    if($(window).width() < 1049) {
        $("body").on("click", "#carousel-portfolio .item", function() {
            ...
            $('.content-modal').empty();
            $('.content-modal').append('<img src="assets/img/portfolio/modal/modal' + id + '.png">');
        ...
        $("body").on("click","#carousel-portfolio .item",function(e){
            ...
            var image = $('<img>',{
                src : `assets/img/portfolio/modal/modal${image_id}.png`
            });
        ...
        if (!animating && !visibleSection.is(":last-of-type")) {
            ...
            visibleSection.removeClass('visible').children('div').velocity(animationParams[1], animationParams[3], animationParams[4]).end().next('.cd-section').addClass('visible').children('div').velocity(animationParams[0], animationParams[3], animationParams[4], function() {
                ...
                if (animate_on == 2) {
                    ...
                    $('.white').addClass('zoomIn2').removeClass('opac');
                    if (checkText) {
                        setTimeout(function() {
                            AnimText(0)
                        }, 1000)
